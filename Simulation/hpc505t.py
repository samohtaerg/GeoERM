...
Original file is located at
    https://colab.research.google.com/drive/1lvoiSgQ_mYmMbG5gqaNiVjSDPgmuZ7-V
"""
...
def main_execution_function(n_tasks_list=[20, 30, 40, 50, 60, 70, 80, 90, 100], n_samples=100, n_features=50, r=3, epsilon=0.1, h=0.5, n_iterations=1):
    ...
    task_id = os.environ.get("SLURM_ARRAY_TASK_ID", "0")  # 如果没有定义，默认为 "0"
...
#n_tasks_list=np.arange(10, 100, 10)
# n_features = 20 (50)
# r = 5 （5）
